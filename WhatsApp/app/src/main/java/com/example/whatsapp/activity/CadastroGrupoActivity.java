...
public class CadastroGrupoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerMembrosSelecionados = findViewById(R.id.recyclerMembrosGrupos);
        ...
        if(resultCode == RESULT_OK){
            ...
            try {
                ...
                if(imagem != null){
                    ...
                    final StorageReference imageRef = storageReference.child("imagens").child("grupos").child(grupo.getId() + ".jpeg");
